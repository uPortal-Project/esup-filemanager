...
public class UserMultivaluedAttributesEvaluator extends UserAttributesEvaluator implements InitializingBean {
    ...
    /** Logger. */
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(UserMultivaluedAttributesEvaluator.class);
    ...
    public boolean isApplicable(PortletRequest request) {
        ...
        if (log.isDebugEnabled()) {
            log.debug("value={}, mode={}, attrib={}", this.getValue(), this.getMode(), attribs);
        }
