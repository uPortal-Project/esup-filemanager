...
public class UserAttributesEvaluator implements IDriveAccessEvaluator, InitializingBean {
    ...
    /** Logger. */
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(UserAttributesEvaluator.class);
    ...
    public boolean isApplicable(PortletRequest request) {
        ...
        if (log.isDebugEnabled()) {
            log.debug("value={}, mode={}, attrib={}", this.getValue(), this.getMode(), attrib);
        }
